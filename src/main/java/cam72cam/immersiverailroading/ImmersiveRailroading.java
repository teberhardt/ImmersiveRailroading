...
@Mod(modid = ImmersiveRailroading.MODID, name="ImmersiveRailroading", version = ImmersiveRailroading.VERSION, acceptedMinecraftVersions = "[1.11,1.12)", dependencies = "required-after:trackapi;required-after:immersiveengineering")
