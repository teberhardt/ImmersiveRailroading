...
public class BuilderSlope extends BuilderStraight {
	...
	public List<VecYawPitch> getRenderData() {
		...
		data.add(new VecYawPitch(pos.xCoord, pos.yCoord, pos.zCoord, -angle, slopeAngle, actualLength, "RAIL_RIGHT", "RAIL_LEFT"));
		...
		for (double i = -trackOffset; i < info.length - trackOffset; i+=gauge.scale()) {
			...
			data.add(new VecYawPitch(pos.xCoord, pos.yCoord + slope * (i+gauge.scale()), pos.zCoord, -angle, slopeAngle, "RAIL_BASE"));
		}
		return data;
	}
}
