...
public class ClientProxy extends CommonProxy {
	...
	public void init(FMLInitializationEvent event) {
		...
		keys.put(KeyTypes.REVERSE_DIRECTION, new KeyBinding("ir_keys.reverse_direction", Keyboard.KEY_SUBTRACT, "key.categories." + ImmersiveRailroading.MODID));
		...
		ClientRegistry.registerKeyBinding(keys.get(KeyTypes.REVERSE_DIRECTION));
