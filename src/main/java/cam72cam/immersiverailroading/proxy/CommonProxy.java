...
public abstract class CommonProxy implements IGuiHandler {
	...
	ImmersiveRailroading.net.registerMessage(PreviewRenderPacket.Handler.class, PreviewRenderPacket.class, 12, Side.CLIENT);
    	...
    	String ingotSteel = OreDictionary.doesOreNameExist("ingotSteel") ? "ingotSteel" : "ingotIron";
    	...
    	GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(IRItems.ITEM_CONDUCTOR_WHISTLE),  
    		    ...
    		    " gg",
    		    'g', "ingotGold"));
    	GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(IRItems.ITEM_PAINT_BRUSH),  
    			"w",
    		    "i",
    		    "s",
    	...
    	GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(IRItems.ITEM_GOLDEN_SPIKE),  
    			"dd ",
			    "d  ",
			    "d  ",
    		    'd', "ingotGold"));
