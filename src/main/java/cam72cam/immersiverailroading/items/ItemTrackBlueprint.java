...
public class ItemTrackBlueprint extends Item {
	...
	public EnumActionResult onItemUse(ItemStack stackIn, EntityPlayer player, World world, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		RailInfo info = new RailInfo(player.worldObj, stack, placementInfo, null);
		info.build(player);
		return EnumActionResult.SUCCESS;
    }
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced)
    {
        ...
        tooltip.add(GuiText.TRACK_RAIL_BED.toString(settings.railBed != null ? settings.railBed.getDisplayName() : ""));
        tooltip.add(GuiText.TRACK_RAIL_BED_FILL.toString(settings.railBedFill != null ? settings.railBedFill.getDisplayName() : ""));
