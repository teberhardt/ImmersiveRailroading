	...
	public class PlateRollerInstance extends MultiblockInstance {
		...
		public boolean onBlockActivated(EntityPlayer player, EnumHand hand, BlockPos offset) {
			if (!player.isSneaking()) {
				...
				} else if (held != null && OreHelper.IR_STEEL_BLOCK.matches(held, false)) {
		...
		public void tick(BlockPos offset) {
			...
			if (progress == 0) {
				...
				if (input != null && OreHelper.IR_STEEL_BLOCK.matches(input, false) && output == null && craftingTe.getCraftItem() != null) {
