...
public abstract class EntityBufferDefinition {
	...
	public EntityBufferDefinition(String defID, JsonObject data) throws Exception {
		this.defID = defID;
		if (data == null) {
	...
	protected Set<String> parseComponents() {
		...
		//addComponentIfExists(RenderComponent.parse(RenderComponentType.TRACK_BUFFER, this, groups), true);
		return groups;
	}
	...
	public EntityBufferDefinition getDefinition() {
		return this.getDefinition(EntityBufferDefinition.class);
	}
	public <T extends EntityBufferDefinition> T getDefinition(Class<T> type) {
