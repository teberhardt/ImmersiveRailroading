...
public class RailBuilderRender {
	...
	public static void renderRailBuilder(RailInfo info) {
		...
		GL11.glTranslated(info.placementPosition.xCoord-info.position.getX(), info.placementPosition.yCoord-info.position.getY(), info.placementPosition.zCoord-info.position.getZ());
