...
public class TileRail extends TileRailBase {
	...
	public void readFromNBT(NBTTagCompound nbt) {
		...
		if (nbt.hasKey("info")) {
            ...
            RailSettings settings = new RailSettings(gauge, type, length, quarters, TrackPositionType.FIXED, TrackDirection.NONE, railBed, null, false, false);
			info = new RailInfo(worldObj, settings, placementInfo, null, switchState, tablePos);
		}
	}
