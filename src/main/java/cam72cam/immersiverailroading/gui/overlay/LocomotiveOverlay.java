...
public class LocomotiveOverlay extends Gui {
	...
	public void drawGauge(int color, float liquidAmount, float tankCapacity, String units) {
		...
		GL11.glPushMatrix();
		{
			...
			drawCenteredString(mc.fontRendererObj, amount, 0, 0, 0xFFFFFF);
		}
		GL11.glPopMatrix();
		GL11.glPushMatrix();
		{
			...
			double scale = 0.5;
			GL11.glScaled(scale, scale, scale);
			drawCenteredString(mc.fontRendererObj, capacity, 0, 0, 0xFFFFFF);
		}
		GL11.glPopMatrix();
	...
	public void drawScalar(String string, float val, float min, float max) {
		...
		GL11.glPushMatrix();
		{
			...
			double scale = 0.5;
			GL11.glScaled(scale, scale, scale);
			drawCenteredString(mc.fontRendererObj, string, 0, 0, 0xFFFFFF);
		}
		GL11.glPopMatrix();
	...
	public void drawSpeedDisplay(Locomotive loco, int offset) {
		...
		GL11.glPushMatrix();
		{
			...
			double scale = 0.75;
			GL11.glScaled(scale, scale, scale);
			drawCenteredString(mc.fontRendererObj, text, 0, 0, 0xFFFFFF);
		}
		GL11.glPopMatrix();
	}
