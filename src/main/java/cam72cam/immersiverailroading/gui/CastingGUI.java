...
public class CastingGUI extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj, fillStr, this.width / 2 - 94 + 27, this.height / 4 + 3 + 25, 14737632);
		this.drawCenteredString(this.fontRendererObj, castStr, this.width / 2 - 28 + 60, this.height / 4 + 67 + 10, 14737632);
	}
