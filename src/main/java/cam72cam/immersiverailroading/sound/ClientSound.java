...
public class ClientSound implements ISound {
	...
	@Override
	public void play() {
		if (repeats || pos == null || Minecraft.getMinecraft().thePlayer == null) {
			sndSystem.play(id);
		} else if (Minecraft.getMinecraft().thePlayer.getPositionVector().distanceTo(pos) < this.attenuationDistance * 1.1) {
			sndSystem.play(id);
		}
	}
	...
	public void setPosition(Vec3d pos) {
		...
		sndSystem.setPosition(id, (float)pos.xCoord, (float)pos.yCoord, (float)pos.zCoord);
	}
